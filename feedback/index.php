...
$form['form-1'] = array(
	'fields' => array(
		'tell' => array(
			...
			'messages' => array(
				'preg' => 'Максимальная длина поля: 11 символов, минимальная: 5',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		...
		'from_email' => 'noreply@email.com',
		'from_name' => 'noreply',
		'to_email' => 'sports-7-zakaz.ru@mail.ru',
		'to_name' => 'noreply1, noreply2',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
$form['form-3'] = array(
	'fields' => array(
		'fio' => array(
			...
			'messages' => array(
				'preg' => 'Максимальная длина поля: 3 символов, минимальная: 35',
				'minlength' => 'Минимальная длинна поля [ %1$s ] меньше допустимой - %2$s',
			)
		),
		'city' => array(
		...
		'index' => array(
			...
			'messages' => array(
				'preg' => 'Максимальная длина поля: 3 символов, минимальная: 15',
				'minlength' => 'Минимальная длинна поля [ %1$s ] меньше допустимой - %2$s',
			)
		),
		'fromCity' => array(
...
$form['form-4'] = array(
	...
	'cfg' => array(
		...
		'from_email' => 'noreply@email.com',
		'from_name' => 'noreply',
		'to_email' => 'sports-7-zvonok.ru@mail.ru',
		'to_name' => 'noreply1, noreply2',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
